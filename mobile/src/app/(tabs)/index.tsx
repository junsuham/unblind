...
import unblindLogo from '../../../assets/brand/unblind-wordmark-relief-v5.png'
    ...
    <Screen contentStyle={{ paddingTop: 0 }} showLogo={false}>
      ...
      >
        <Pressable onPress={() => router.replace('/')} accessibilityLabel="언블라인드 홈">
          <Image source={unblindLogo} alt="UNBLIND" accessibilityLabel="UNBLIND" style={{ width: 112, height: 25, tintColor: colors.logoInk }} resizeMode="contain" />
        </Pressable>
