  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, justifyContent: 'center', padding: 28, backgroundColor: '#140F0D' }}>
        ...
        <Pressable accessibilityRole="button" accessibilityLabel="앱 다시 불러오기" onPress={this.retry} style={{ minHeight: 52, borderRadius: 16, backgroundColor: '#E45330', justifyContent: 'center', alignItems: 'center', marginTop: 24 }}>
