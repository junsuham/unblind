...
const policies: Record<string, Policy> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '처리 위탁과 외부 서비스', body: '서비스 제공을 위해 Google(로그인), Supabase(인증·데이터베이스·파일 저장), Vercel(웹 호스팅), Expo 및 브라우저 푸시 제공자(선택한 알림), YouTube와 OpenStreetMap 계열 서비스(찬양·위치 검색)를 이용할 수 있습니다. 푸시 알림은 사용자가 허용한 경우에만 등록됩니다.' },
