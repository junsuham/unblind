...
const policies: Record<string, Policy> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '처리 항목', body: 'Google 이메일과 계정 식별자, 소셜 연령 확인 결과, 출석 교회와 선택 입력한 하위 부서, 현재 상태, 랜덤 닉네임, 글·댓글·반응·신고·차단 기록, 고객지원 이메일·문의 내용·처리 기록, 접속 및 오류 기록, 선택한 경우 기기 푸시 구독 정보를 처리합니다. 종교·교회 정보는 별도 동의를 받아 가입 확인과 안전한 운영에만 사용하며 다른 사용자에게 공개하지 않습니다.' },
      { title: '보유 기간', body: '회원 정보는 회원 기간 동안 보관하고 계정 삭제 시 삭제합니다. 읽은 알림과 오류 기록은 90일, 비활성 알림 구독은 30일, 계정 삭제 감사 기록과 처리 완료 신고의 신고자 정보 및 처리 완료 고객지원 문의는 1년, 운영 조치 이력은 2년 이내 보관 후 정리합니다. 법령상 별도 보존 의무가 있으면 해당 기간을 우선합니다.' },
      ...
      { title: '문의와 권리 행사', body: '개인정보 관련 문의와 권리 행사는 고객지원 페이지의 앱 내 문의 접수 또는 공개된 이메일로 신청할 수 있습니다. 개인정보 보호 담당은 언블라인드 운영팀이며, 본인 확인 후 처리 결과를 입력한 이메일로 안내합니다.' },
