...
const policies: Record<string, Policy> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '처리 항목', body: 'Google 이메일과 계정 식별자, 소셜 연령 확인 결과, 출석 교회와 현재 상태, 랜덤 닉네임, 글·댓글·반응·신고·차단 기록, 고객지원 이메일·문의 내용·처리 기록, 접속 및 오류 기록, 선택한 경우 기기 푸시 구독 정보를 처리합니다. 다른 사용자에게 이메일과 교회 정보는 공개하지 않습니다.' },
