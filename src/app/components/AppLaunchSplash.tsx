...
export function AppLaunchSplash() {
  ...
  return (
    <div className={`ub-launch-splash fixed inset-0 z-[300] flex items-center justify-center bg-[#e15331] px-8 pb-[env(safe-area-inset-bottom)] pt-[env(safe-area-inset-top)] ${leaving ? 'ub-launch-splash-leaving' : ''}`} aria-label="언블라인드 시작 화면">
