...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/icons/icon-192-v5.png", sizes: "192x192", type: "image/png" },
      { url: "/icons/icon-512-v5.png", sizes: "512x512", type: "image/png" },
    ],
    apple: [
      { url: "/icons/apple-touch-icon-v5.png", sizes: "180x180", type: "image/png" },
    ],
  },
};
